@extends('layouts.app', ['page' => __('Stats AMB 30 day descending'), 'pageSlug' => 'amb30Ttdes'])
      ...
      <div class="card-body">
        <div class="places-buttons">
         ...
         <div class="row">
            ...
            <div class="row">
                <div class="col-md-3">
                  <a  href="{{ route('pages.amb')  }}" class="btn btn-primary btn-block">วันนี้</a>
                </div>
                <div class="col-md-3">
                <a  href="{{ route('pages.stats1day')  }}" class="btn btn-primary btn-block">ย้อนหลัง 1 วัน</a>
                </div>
                <div class="col-md-3">
                <a  href="{{ route('pages.stats7day')  }}" class="btn btn-primary btn-block">ย้อนหลัง 7 วัน</a>
                </div>
                <div class="col-md-3">
                  <a  href="{{ route('pages.stats30day')  }}" class="btn btn-primary btn-block">ย้อนหลัง 30 วัน</a>
                </div>
      ...
      <div class="card-body">
        ...
        <div class="places-buttons">
          <div class="row">
            ...
            <div class="col-md-6 ml-auto mr-auto text-center">
              <h4 class="card-title" >
                      STATS ย้อนหลัง 30 วัน Total มากไปหาน้อย
              </h4>
        ...
        <thead>
            ...
            <th><div scope="col">
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('pages.amb30Todes')  }}">Turn over มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.amb30Toasc')  }}">Turn over น้อยไปมาก</a>
                    </div>
                </div>
              </th>
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('pages.amb30Windes')  }}">Win มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.amb30Winasc')  }}">Win น้อยไปมาก</a>
                    </div>
                </div>
              </th>
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('pages.amb30Lossdes')  }}">Loss มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.amb30Lossasc')  }}">Loss น้อยไปมาก</a>
                    </div>
                </div>
              </th>
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('pages.amb30Ttdes')  }}">Loss มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.amb30Ttasc')  }}">Loss น้อยไปมาก</a>
                    </div>
                </div>
              </th>
            </tr>
          ...
          <?php
                    ...
                    $postData = [
                        ...
                        "agenttoken"=> "4e60792106a7c07d9965286b74da8dad",
                        "type" => 0,
                        "day" => -30,
                        "start" =>   "",
                        "end" =>   ""
                    ...
                    if ($error_code == 404 ) {
                      ...
                      $html2 .= '<tr>
                           ...
                           <th><font color="#FFF"></th>
                            ...
                            return $b['win']-$a['win'] <=> $b['loss']-$a['loss'];
                            });
