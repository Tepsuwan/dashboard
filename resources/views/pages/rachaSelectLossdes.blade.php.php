@extends('layouts.app', ['page' => __('Stats Racha 30 day descending'), 'pageSlug' => 'racha30Lossdes'])
...
@section('content')
  ...
  <div class="dropdown-menu" >
    ...
    <a class="dropdown-item" href="{{ route('pages.racha30Ttdes')  }}">Total มากไปน้อย</a>
    <a class="dropdown-item" href="{{ route('pages.racha30Ttasc')  }}">Total น้อยไปมาก</a>
        ...
        <div class="places-buttons">
          <div class="row">
            ...
            <div class="col-md-6 ml-auto mr-auto text-center">
              <h4 class="card-title" >
                      STATS ย้อนหลัง 30 วัน Turn over มากไปหาน้อย
              </h4>
