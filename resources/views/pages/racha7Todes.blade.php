@extends('layouts.app', ['page' => __('Stats Racha 7 day descending'), 'pageSlug' => 'racha7Todes'])
      ...
      <div class="card-body">
        <div class="places-buttons">
          <div class="row">
            <div class="col-md-6 ml-auto mr-auto text-center">
              <h4 class="card-title" >
                STATS RACHA ย้อนหลัง 7 วัน Total over จากมากไปหาน้อย
              </h4>
          ...
          <thead>
            ...
            <th><div scope="col">
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('pages.racha7Todes')  }}">Turn over มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.racha7Toasc')  }}">Turn over น้อยไปมาก</a>
                    </div>
                </div>
              </th>
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('pages.racha7Windes')  }}">Win มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.racha7Winasc')  }}">Win น้อยไปมาก</a>
                    </div>
                </div>
              </th>
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('pages.racha7Lossdes')  }}">Loss มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.racha7Lossasc')  }}">Loss น้อยไปมาก</a>
                    </div>
                </div>
              </th>
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('pages.racha7Ttdes')  }}">Loss มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.racha7Ttasc')  }}">Loss น้อยไปมาก</a>
                    </div>
                </div>
              </th>
            </tr>
