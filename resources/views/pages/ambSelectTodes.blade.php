@extends('layouts.app', ['page' => __('Select date'), 'pageSlug' => 'ambSelectTodes'])
...
@section('content')
  ...
  <div class="dropdown-content" >
    <a class="dropdown-item" href="{{ route('pages.ambSelectTodes')  }}">Turn over มากไปน้อย</a>
    <a class="dropdown-item" href="{{ route('pages.ambSelectToasc')  }}">Turn over น้อยไปมาก</a>
    <a class="dropdown-item" href="{{ route('pages.ambSelectWindes')  }}">Win มากไปน้อย</a>
    <a class="dropdown-item" href="{{ route('pages.ambSelectWinasc')  }}">Win น้อยไปมาก</a>
    <a class="dropdown-item" href="{{ route('pages.ambSelectLossdes')  }}">Loss มากไปน้อย</a>
    <a class="dropdown-item" href="{{ route('pages.ambSelectLossasc')  }}">Loss น้อยไปมาก</a>
    <a class="dropdown-item" href="{{ route('pages.ambSelectTtdes')  }}">Total มากไปน้อย</a>
    <a class="dropdown-item" href="{{ route('pages.ambSelectTtasc')  }}">Total น้อยไปมาก</a>
        ...
        <div class="places-buttons">
          <div class="row">
            <div class="col-md-6 ml-auto mr-auto text-center">
            <h5 class="card-title">
                STATS ย้อนหลัง {{date('d-m-Y', strtotime($fromdate))}} ถึงวันที่ {{date('d-m-Y', strtotime($todate))}}
              </h5>
