@extends('layouts.app', ['page' => __('Stats Racha 1 day descending'), 'pageSlug' => 'racha1Todes'])
      ...
      <div class="card-body">
        <div class="places-buttons">
          <div class="row">
            <div class="col-md-6 ml-auto mr-auto text-center">
              <h4 class="card-title" >
                STATS RACHA ย้อนหลัง 1 วัน Total over จากมากไปหาน้อย
              </h4>
          ...
          <thead>
            ...
            <th><div scope="col">
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('pages.racha1Todes')  }}">Turn over มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.racha1Toasc')  }}">Turn over น้อยไปมาก</a>
                    </div>
                </div>
              </th>
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('pages.racha1Windes')  }}">Win มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.racha1Winasc')  }}">Win น้อยไปมาก</a>
                    </div>
                </div>
              </th>
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('pages.racha1Lossdes')  }}">Loss มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.racha1Lossasc')  }}">Loss น้อยไปมาก</a>
                    </div>
                </div>
              </th>
              ...
              <th><div scope="col" class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('pages.racha1Ttdes')  }}">Loss มากไปน้อย</a>
                    <a class="dropdown-item" href="{{ route('pages.racha1Ttasc')  }}">Loss น้อยไปมาก</a>
                    </div>
                </div>
              </th>
            </tr>
