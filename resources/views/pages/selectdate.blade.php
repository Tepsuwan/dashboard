@extends('layouts.app', ['page' => __('Select date'), 'pageSlug' => 'selectdate'])
                      ...
                      for ($i = 0; $i < count($obj['data']) ; $i++) {
                         ...
                         if ($sum < 0 )
                         {
                          switch ($idgame) {
                            ...
                            break;
                            case 18:
                            $namegame = 'ผจญภัยแดนคนเถื่อน';
                            break;
                            case 19:
                            $namegame = 'ไรส์ออฟอียิปต์';
                            break;
                            case 20:
                            $namegame = 'เซอร์คัส';
                            break;
                            ...
                            break;
                            case 24:
                            $namegame = 'แชมเปี้ยนออฟเดอะเวิร์ล';
                            break;
                            case 25:
                            $namegame = 'โจ๊กเกอร์';
                            break;
                            ...
                            break;
                            case 39:
                            $namegame = 'เซอร์กิตกรังปรีย์';
                            break;
                            case 40:
                            $namegame = 'สล็อตแมชชีน';
                            break;
                            case 41:
                            $namegame = 'คิวปิด';
                            break;
                           ...
                           <th><font color=" #16F529">'.$total4.'</th>
