@extends('layouts.app', ['page' => __('Bot slot edit'), 'pageSlug' => 'botslotedit'])
          ...
          <div class="row">
            <div class="col-md-6 ml-auto mr-auto text-center">
              <h2 class="card-title">
                ...
                <form action = "botsloteditsuccess" method = "GET">
                        ...
                        <div class = "row">
                            ...
                            <div class="form-outline col-md-6 mb-4 ">
                            <p class="form-label text-left">New Brand</p>
                            <input type="text" class="form-control" name = "newbrand" autocomplete="off" required/>
                            </div>
